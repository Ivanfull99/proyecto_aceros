...
<h1>Aceros</h1>
    ...
    <input type="number" name="tipo_calibre" id="tipo_calibre" value="{{$acero->tipo_calibre}}"><br>
    @error('tipo_calibre')
    <h2>{{$message}}</h2>
    @enderror

    <label for="costos">costo</label><br>
    <input type="number" name="costos" id="costos" step="0.01" min="0" value="{{$acero->costos}}"><br>
    @error('costos')
    <h2>{{$message}}</h2>
    @enderror

    <label for="cantidad">cantidad</label><br>
    <input type="number" name="cantidad" id="cantidad" min="0" value="{{$acero->cantidad}}"><br>
    @error('cantidad')
    <h2>{{$message}}</h2>
    @enderror
